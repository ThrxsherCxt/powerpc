...
DELIMITER // 
CREATE PROCEDURE `calc_monthly_payments` ( IN product_id INT(11), IN total_payments INT )
BEGIN
...
DELIMITER // 
CREATE PROCEDURE `updateMetainfo`(IN product_id_IN INT(11))
BEGIN
...
INSERT INTO products (id, name, description, price, views, image, category_id) VALUES (10, 'Computadora Dell Optiplex I5 2da Gen Con 4gb Ram Y 250gb Hdd', '<h3>Especificaciones</h3><b>Marca</b> : Dell<br><b>Condición del ítem</b> : Reacondicionado<br><b>Modelo</b> : Optiplex<br>', 3649,8356, 'http://http2.mlstatic.com/D_632233-MLM48439649298_122021-O.jpg', 'MLM438450');
INSERT INTO products (id, name, description, price, views, image, category_id) VALUES (11, 'Xtreme Pc Intel Quad Core J4105 8gb Ssd 240gb Wifi', '<h3>Especificaciones</h3><b>Marca</b> : XTREME PC GAMER<br><b>Condición del ítem</b> : Nuevo<br><b>Modelo</b> : XTACIC8GBHD610<br><b>Largo del paquete</b> : 51 cm<br><b>Peso del paquete</b> : 940 g<br>', 3699,7137, 'http://http2.mlstatic.com/D_715593-MLM49851889000_052022-O.jpg', 'MLM438450');
INSERT INTO products (id, name, description, price, views, image, category_id) VALUES (12, 'Xtreme Pc Amd Radeon Vega Ryzen 5 4650g 16gb Ssd 3tb Wifi', '<h3>Especificaciones</h3><b>Marca</b> : XTREME PC GAMING<br><b>Condición del ítem</b> : Nuevo<br><b>Modelo</b> : XTPCR516GBRENOIR<br>', 7949.5,5372, 'http://http2.mlstatic.com/D_751354-MLM49684143924_042022-O.jpg', 'MLM438450');
INSERT INTO products (id, name, description, price, views, image, category_id) VALUES (13, 'Computadora Dell Core I5 6ta Gen 16gb 1tb Monitor 22 Wifi  ', '<h3>Especificaciones</h3><b>Marca</b> : Dell /HP<br><b>Condición del ítem</b> : Reacondicionado<br><b>Modelo</b> : Optiplex 3040 /600G3<br>', 7832,9102, 'http://http2.mlstatic.com/D_949999-MLM42285663467_062020-O.jpg', 'MLM438450');
INSERT INTO products (id, name, description, price, views, image, category_id) VALUES (14, 'Xtreme Pc Amd Radeon Rx 550 Ryzen 4700s 16gb Monitor 23.8', '<h3>Especificaciones</h3><b>Marca</b> : XTREME PC GAMING<br><b>Condición del ítem</b> : Nuevo<br><b>Modelo</b> : XTPCGR716GBRX550BM<br><b>Largo del paquete</b> : 59.5 cm<br><b>Peso del paquete</b> : 13120 g<br>', 10899,7789, 'http://http2.mlstatic.com/D_689577-MLM49221826110_022022-O.jpg', 'MLM438450');
INSERT INTO products (id, name, description, price, views, image, category_id) VALUES (15, 'Apple Mac Mini Late 2014 Intel I5 8gb 1tb Ox', '<h3>Especificaciones</h3><b>Marca</b> : Apple<br><b>Condición del ítem</b> : Reacondicionado<br><b>Línea</b> : Mac Mini<br><b>Modelo</b> : Mac Mini 2.5 GHz<br><b>Largo del paquete</b> : 43.2 cm<br><b>Peso del paquete</b> : 1900 g<br>', 5979.08,7648, 'http://http2.mlstatic.com/D_692832-MLM51717361327_092022-O.jpg', 'MLM438450');
INSERT INTO reviews (name, text, rate, product_id) VALUES ('Bueno', 'Podía haber sido excelente, pero lamentablemente un detalle dió al traste. La base que adjuntan para sostener la pantalla, no embona como debiera en la parte de los tornillos. Se ve que no tuvieron la curiosidad de probarla antes y lo hubieran detectado perfectamente. Lo pude solucionar, pero aprendí que no debo comprar usado sin ver el equipo antes bien armado. Por lo demás, ha funcionado bién. Lastima de este importante detalle. Por eso los califico así.', 3, 1);
INSERT INTO reviews (name, text, rate, product_id) VALUES ('BUEN PRODUCTO', 'Hola, te compré super computadora intel core, solo quiero saber si esta tiene antivirus, la instalé pero poco a poco la voy usando, y quiero saber sobre el antivirus por seguridad.', 4, 2);
INSERT INTO reviews (name, text, rate, product_id) VALUES ('Muy malo', 'Ni mercado libre ni el proovedor me hicieron efectiva la garantía a los 2 meces la computadora dejo de funcionar y nadie me ha ofcrecido garantía sobre mi compra.', 1, 3);
INSERT INTO reviews (name, text, rate, product_id) VALUES ('Muy bueno', 'Es excelente muy rapida se los recomiendo es una compañia que si cumple lomque ofrece.', 4, 4);
INSERT INTO reviews (name, text, rate, product_id) VALUES ('Excelente', 'Justo lo que buscaba. Buen producto. Volvería a comprar con pc1.', 5, 5);
INSERT INTO reviews (name, text, rate, product_id) VALUES ('Aceptable', 'El cpu bien el monitor regular pero teclado y mouse de muy baja calidad, sin embargo por el precio se comprende, pero si avisaran que por un extra se puede tener todo de la misma marca dell pues podríamos considerarlo.', 3, 6);
INSERT INTO reviews (name, text, rate, product_id) VALUES ('Excelente', 'Muy bue equipo justo lo que espera a x por el precio! solo un detallito con el teclado que escribía otra letra pero de ahí en fuera todo en buen estado.', 5, 7);
INSERT INTO reviews (name, text, rate, product_id) VALUES ('Lo mejor de lo mejor ', 'Lo mejor de lo mejor. Yo pregunto poco pero compro mucho hubo un detalle pero me lo resolvieron inmediatamente. Recomendó mucho el producto!!.', 5, 8);
INSERT INTO reviews (name, text, rate, product_id) VALUES ('Muy bueno', 'Buen producto, cumple con lo prometido y el rendimiento es bueno. Hubo un par de detalles, comprensibles por la naturaleza del producto.', 4, 9);
INSERT INTO reviews (name, text, rate, product_id) VALUES ('Excelente', 'Muy buena pc y buen precio y para lo que la necesite me funciona a la perfeccion.', 5, 10);
INSERT INTO reviews (name, text, rate, product_id) VALUES ('Cumplió mis expectativas, recomendado', 'De lo mejor que puedes encontrar en relación a calidad/precio. Dado a que en la misma publicación aclaran que los componentes varían, les digo que ese no es el gabinete que trae sino el \"aerocool quartz revo rgb atx negro\" y que la tarjeta madre es una \"gigabyte micro atx a520m ds3h\" la cual trae 4 slots para ram. En cuanto al rendimiento, la grafica integrada del procesador es de 2 gb. Pese a eso, me ha permitido correr juegos en diversas calidades como los siguientes:. Far cry 3 - muy alta. Rise of the tomb raider - alta. Shadow of the tomb raider - alta. Gta v - la mayoría de los ajustes entre alta y normal. Eso sí, no llega a los 60 fps, para eso si hay que bajarle a alguna característica del juego. El encendido y apagado es muy rápido y el gabinete es prácticamente silencioso a menos que se le exija bastante. Otro comentario es que el adaptador wi fi que tiene es muy básico, de corto alcance y apenas alcanza los y su maximo supuestamente es de 150 mbps, así que muy probablemente tendrán que comprar uno de mayor calidad o conectarlo al router.', 4, 11);
INSERT INTO reviews (name, text, rate, product_id) VALUES ('Buena, aunque aún falta darle más uso', 'Buena computadora. Enciende rápido, la uso para cálculos y los realiza en un buen tiempo, sin embargo he sufrido un bloqueo al estar viendo un video y la computadora no reaccionó más, al grado que tuve que reiniciarla. Me está surgiendo la duda de regresarla a garantía por este hecho.', 5, 12);
INSERT INTO reviews (name, text, rate, product_id) VALUES ('Buena', 'La verdad muy recomendado , me sirvio para jugar la mayoria de juegos populares en calidad media a 60 fps , y de parte para la escuela tambien me sirvio bastante ya que en general la computadora es buena en todos los aspectos (recomendada para iniciar).', 5, 13);
INSERT INTO reviews (name, text, rate, product_id) VALUES ('Excelente ', 'Excelente pc, en el mercado no hay nada igual en calidad y precio. Yo desarrollo contenido con ella y puedo decir que es la mejor inversión que pude hacer.', 5, 14);
INSERT INTO reviews (name, text, rate, product_id) VALUES ('Bueno', 'Le daría 5 estrellas pero en la publicación decís dos stocks de 8 gb para el dual chanel y solo traí un stock de 16.', 4, 15);
INSERT INTO reviews (name, text, rate, product_id) VALUES ('Excelente equipo', 'Funciona perfectamente, incluye todo lo que incluía y a un muy buen precio. Lo recomiendo mucho si buscas una computadora potente y no quieres gastar en una nueva.', 5, 1);
INSERT INTO reviews (name, text, rate, product_id) VALUES (' Muy bien exelente producto', 'Me gusto mucho a pesar que no es un producto nuevo esta muy conservada el equipo lo recomiendo es justo lo que necesitaba para mi negocio.', 5, 2);
INSERT INTO reviews (name, text, rate, product_id) VALUES ('No lo recomiendo dinero tirado a la basura ', 'Me empezo a fallar a los dos meses y ahora me dicen que tengo que comprar un disco duro. o se vale que vendan equipos dañados.', 1, 3);
INSERT INTO reviews (name, text, rate, product_id) VALUES ('Bueno', 'Pues el monitor de la carcasa esta rayado, y el cpu esta rayado, y se escucha mucho el disco duro no se si sea normal.', 3, 4);
INSERT INTO reviews (name, text, rate, product_id) VALUES ('Recomendado ', 'Excelente equipo lo recomiendo todo cumplido lo único que les falta es como especificar que equipos quedan de marca.', 5, 5);
